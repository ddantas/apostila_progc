...
\title{Notas de aula de COMP0512, Programação C - Programação em C}
...
\lstinputlisting[caption=series.c]{src/pause.c}
...
\lstinputlisting[caption=ascii.c]{src/ascii.c}
...
\lstinputlisting[caption=dado.c]{src/dado.c}
...
\lstinputlisting[caption=series.c]{src/primos.c}
...
\lstinputlisting[caption=series.c]{src/series.c}
...
\lstinputlisting[caption=generate.c]{src/generate.c}
...
\lstinputlisting[caption=ordena.c]{src/ordena.c}
